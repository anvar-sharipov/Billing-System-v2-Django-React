  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 flex">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="flex-1 flex flex-col ml-64 mr-64 transition-colors duration-300 bg-gray-100 dark:bg-gray-900/50 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 backdrop-blur-sm"
      >
        {/* Header */}
